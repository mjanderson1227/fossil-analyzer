...
public partial class MLModel1
{
    ...
    public static IDataView LoadImageFromFolder(MLContext mlContext, string folder)
    {
        ...
        if (subDirectories.Length == 0) throw new Exception("fail to find subdirectories");
    ...
    public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
    {
        ...
        var pipeline = mlContext.Transforms.Conversion
            .MapValueToKey(@"Label", @"Label", addKeyValueAnnotationsAsText: false)
            .Append(mlContext.MulticlassClassification.Trainers.ImageClassification(scoreColumnName: @"Score",
